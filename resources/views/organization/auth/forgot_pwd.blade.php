									...
									{{-- <div class="card-body"> --}}
										...
										<form method="POST" action="{{ url('organization/forgot/password') }}">
											...
											<div class="form-group form-box">
												<input id="email" type="email" class="form-control  @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Email Address" aria-label="Email Address" autofocus>
												@error('email')
											...
											<div class="form-group">
												<button type="submit" class="btn-md btn-theme w-45 mr-4">Send</button>
												<button type="submit" class="btn-md btn-theme w-45">Cancel</button>
											</div>
											{{-- <div class="row">
