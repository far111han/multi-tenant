      ...
      <div class="row">
         <div class="col-xl-5 col-lg-5 col-md-12 bg-color-10">
            <div class="form-section">
               ...
               <div class="login-inner-form">
                  <form method="POST" action="{{ url('organization/login') }}" id="sellerlogin">
                     ...
                     <div class="checkbox form-group form-box">
                        ...
                        <a href="{{ url('organization/password/reset')}}">Forgot passsword?</a>
                     </div>
               ...
               <p>Don't have an account? Select a package and<a href="{{route('organization.register')}}" class="thembo"> <b style="color: #094d99;">Sign Up</b></a></p>
            </div>
         </div>
