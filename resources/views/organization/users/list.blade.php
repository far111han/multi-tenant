    ...
    <div class="row">
        ...
        <div class="e-panel card">
            <div class="card-header justify-content-between">
                ...
                <div class="">
                    <button type="button" class="btn btn-primary" id="imp_btn" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">Import</button>
                    <a href="{{ url('/organization/users/create') }}" class="btn btn-primary"><i
                ...
                <div class="row" id="filters">
                    <div class="row">
                        <div class="col-md-1 p-0">
                            <button class="btn whit-btn" style="width: 100%;" type="button" id="show-filter">
                                <i class="fa fa-filter" aria-hidden="true"></i>
                                Filter
                            </button>
                        </div>
                    </div>
                    <div class="course-filter p-0 mt-4" style="display: none;">
                        <div class="row pb-2">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group float-right">
                                            ...
                                            <a href="{{ route('organization.my_training_programs.index') }}"
                                                class="btn whit-btn" style="color: #e71440 !important;"
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-4 mb-5">
                                                <div class="drop">
                                                    <button type="button" class="btn btn-primary text-center p-5">
                                                        <div style="font-size: 40px;"><i class="fa fa-file-text-o" aria-hidden="true"></i></div>
                                                        <div>Page Of Information</div>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-5">
                                                <div class="drop">
                                                    <button type="button" class="btn btn-primary text-center p-5">
                                                        <div style="font-size: 40px;"><i class="fa fa-file-code-o" aria-hidden="true"></i></div>
                                                        <div>Web Content</div>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mb-5">
                                                <div class="drop">
                                                    <button type="button" class="btn btn-primary text-center p-5">
                                                        <div style="font-size: 40px;"><i class="fa fa-volume-up" aria-hidden="true"></i></div>
                                                        <div>Audio</div>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="drop">
                                                    <button type="button" class="btn btn-primary text-center p-5">
                                                        <div style="font-size: 40px;"><i class="fa fa-film" aria-hidden="true"></i></div>
                                                        <div>Video</div>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="drop">
                                                    <button type="button" class="btn btn-primary text-center p-5">
                                                        <div style="font-size: 40px;"><i class="fa fa-television" aria-hidden="true"></i></div>
                                                        <div>Presentation / Document</div>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="drop">
                                                    <button type="button" class="btn btn-primary text-center p-5">
                                                        <div style="font-size: 40px;"><i class="fa fa-hdd-o" aria-hidden="true"></i></div>
                                                        <div>Assessment</div>
                                                    </button>
                                                </div>
                                            </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('organization/user/import') }}" method="POST" enctype="multipart/form-data"
                        id="importform">
                        <div class="row">
                            ...
                            <div class="col-md-12 d-flex justify-content-end">
                                ...
                                {{-- <div class="col-md-1 mb-5">
                                                        <a class="btn btn-warning" href="{{ url('organization/user/export') }}">Export</a>
                                                    </div> --}}
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-import">Save changes</button>
                </div>
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.course-filter .active_filters').on('change', function() {
                var branch_id = $('.course-filter #branch_id').val();
                var dep_id = $('.course-filter #dep_id').val();

                $(".userlist").DataTable().ajax.url("{{ url('/organization/users') }}?branch_id=" +
                    branch_id + "&dep_id=" + dep_id).load();
            });
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('change', '#country_id', function() {
                $.ajax({
                    type: "POST",
                    url: '{{ url('organization/getDropdown') }}',
                    data: {
                        table: 'states',
                        field: 'country_id',
                        value: this.value,
            ...
            $('body').on('submit', '#OrgBasicForm', function(e) {
                ...
                $('#OrgBasicForm #save_btn').attr('disabled', true);
                $('#OrgBasicForm #save_btn').text('Validating...');
                $.ajax({
                    type: "POST",
                    ...
                    success: function(data) {
                        if (data == 'success') {
                            $('#OrgBasicForm #save_btn').text('Saving...');
                            $('#OrgBasicForm #cancel_btn').trigger('click');
                            // document.register.submit();
                            submitForm(formData, 'OrgBasicForm', 'save_btn');
                            return false;
                            return false;
                        } else {
                            var errKey = '';
                            ...
                            $.each(data, function(key, value) {
                                ...
                                if (key == "org_image") {
                                    ...
                                    $('#OrgBasicForm #' + key).parents('.form-group')
                                        .find('.error').html(value);
                                }
                            ...
                            $('#OrgBasicForm #save_btn').attr('disabled', false);
                            $('#OrgBasicForm #save_btn').text('Save');
                            return false;
                        }
                        return false;
                    }
            ...
            $('body').on('click', '.btn-import', function(e) {
                ...
                $('#importform .error').html('');

                //  e.preventDefault();
                var formData = new FormData($('#importform')[0])
                $('#importform #imp_btn').attr('disabled', true);
                $('#importform #imp_btn').text('Validating...');
                $.ajax({
                    type: "POST",
                    url: '{{ url('/organization/user-import/validate') }}',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: function(data) {
                        if (data == 'success') {
                            $('#importform #imp_btn').text('Saving...');
                            importFile(formData, 'importform', 'imp_btn');
                            return false;
                            return false;
                        } else {
                            var errKey = '';
                            ...
                            $.each(data, function(key, value) {
                                ...
                                if (key == "choose_file") {
                                    ...
                                    $('#importform #' + key).parents('.form-group')
                                        .find('.error').html(value);
                                }
                            });
                            $('#importform #' + errKey).focus();
                            $('#importform #imp_btn').attr('disabled', false);
                            $('#importform #imp_btn').text('Import');
                            return false;
                        }
                        return false;
                    }
            ...
            function importFile(postValues, form, button) {
                $.ajax({
                    type: "POST",
                    url: '{{ url('organization/user/import') }}',
                    data: postValues,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: function(data) {
                        ...
                        var msg = 'User data imported successfully!';
                        toastr.success(msg);
                        $("#file").val(null);
        ...
        $(function() {
            $('body').on('change', '.active_status', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: '{{ url('/organization/user/status') }}',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id: selid,
                        status: status
        ...
        function deleteUser(id) {
            ...
            swal({
                ...
                if (inputValue == true) {
                    $.ajax({
                        type: "POST",
                        url: '{{ url('/organization/user/delete') }}',
                        data: {
                            "_token": "{{ csrf_token() }}",
                            id: id
                        },
                        success: function(data) {
                            ...
                            setTimeout(function() {
                                var id = $("ul.tabs > li > a.active").attr("href");
