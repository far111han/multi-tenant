...
@section('page-header')
						<!--Page header-->
@php
$edit= userPermission(13,'edit');                 //user permission pass module id , column name of table module action
$delete= userPermission(13,'delete');
@endphp
											...
											<div class="card-header justify-content-between">
												...
												<div>
												   <div class="form-group m-0 addbtn">
													<a href="{{ url('/admin/user-roles/create') }}" class="btn btn-primary addmodule">
														<i class="fe fe-plus mr-1"></i>Add New</a>
												   </div>
												</div>
											 </div>
											<div class="card-body">
																...
																<tr>
																	...
																	<td class="align-middle">
																		<div class="btn-group align-top">
																			@if($row['id'] !=1)
																			@if($edit== true)
																			<a href="{{ url('admin/user-roles/edit/') }}/{{$row['id']}}" class="mr-2 btn btn-sm border-0 editmodule">
																				<i class="fe fe-edit text-green mr-1"></i>
																			</a>
																			@endif
																			@if($delete == true)
																				<button class="btn btn-sm border-0 deletemodule" type="button" data-users="{{$row['assigned_users']}}">
																					<i class="fe fe-trash-2 text-red mr-1"></i>
																				</button>
																			@endif
																			@endif
																		</div>
