...
<!--
																...
																<div class="row">
																	...
																	<div class="col-md-6">
																		<div class="form-group">
																			...
																			{!! Form::select('is_active', array('1' => 'Active', '0' => 'Inactive'), $userrole->is_active,['class' => 'form-control','required','id'=>'module_status']); !!}
																		</div>
																	</div>
																</div>
                    ...
                    <div class="col-12 heading mb-3">
						<div class="row">
							...
							<div class="col-2 d-flex align-items-center citems">View <span class="d-block radiospan ml-2 pt-1"><input type="checkbox" id="view-all" class="mr-1" >All</span></div>
							<div class="col-2 d-flex align-items-center citems">Edit <span class="d-block radiospan ml-2 pt-1"><input type="checkbox" id="edit-all" class="mr-1" >All</span></div>
							<div class="col-2 d-flex align-items-center citems">Delete <span class="d-block radiospan ml-2 pt-1"><input type="checkbox" id="delete-all" class="mr-1" >All</span></div>
						</div>
					</div>
 ...
 @if($modules && count($modules) > 0)
                    @foreach($modules as $row)
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-6 col-5 title">{{$pt['id']}}).{{$pt['name']}}</div>
